...
chip_pool = 100
bet = 1
restart_phrase = "Please 'd' to deal the cards again, or press 'q' to quit"
        ...
        while True:
            ...
            try:
                ...
                if bet_comp >= 1 and bet_comp <= chip_pool:
                    ...
                    print "Invalid bet, you have " + str(chip_pool) + " remaining"
            except:
                print "Input bet, you have " + str(chip_pool) + " remaining"
                continue
            else:
                break
...
def deal_cards():
    ...
    result = 'Hit or Stand? Please either h or s: '
